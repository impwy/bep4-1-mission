...
public class PayoutDataInit {
    ...
    private final Job payoutCollectItemsAndCompetedPayoutsJob;

    public PayoutDataInit(
            @Lazy PayoutDataInit self,
            PayoutFacade payoutFacade,
            JobOperator jobOperator,
            Job payoutCollectItemsAndCompetedPayoutsJob
    ) {
        this.self = self;
        this.payoutFacade = payoutFacade;
        this.jobOperator = jobOperator;
        this.payoutCollectItemsAndCompetedPayoutsJob = payoutCollectItemsAndCompetedPayoutsJob;
    }
    ...
    public void runCollectItemsAndCompletePayoutsBatchJob() {
        ...
        try {
            JobExecution execution = jobOperator.start(payoutCollectItemsAndCompetedPayoutsJob, jobParameters);
